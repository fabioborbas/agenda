...
<body>
    <div class="container">
        <header class="header">
            <h1 id="title" class="text-center">Novo Contato</h1>
        ...
        <div class="form-wrap">
            ...
            <form id="survey-form" action="../api/create.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone" id="telefone" placeholder="(xx)xxxxx-xxxx" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="row">
